...
export default function RegisterForm9() {
  ...
  return (
    <div className="w-full min-h-[480px] max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-center bg-[#101613] rounded-3xl shadow-2xl p-0 overflow-hidden border border-yellow-700">
      {/* Formulario */}
      <div className="flex-1 px-8 py-10 flex flex-col justify-center">
        <h2 className="text-2xl font-bold text-yellow-400 mb-1 tracking-wide">CREAR CUENTA</h2>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="name9" className="block text-sm font-semibold text-gray-200 mb-1">Nombre completo</label>
            <Input
              id="name9"
              type="text"
