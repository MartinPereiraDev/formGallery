...
export default function LoginForm10() {
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-gray-50 rounded-3xl p-4 flex flex-col items-center relative font-mono shadow-[inset_6px_6px_12px_rgba(0,0,0,0.2),inset_-6px_-6px_12px_rgba(255,255,255,0.9)]">
      <div className={`w-32 h-32 mb-6 rounded-full overflow-hidden border-2 border-blue-200 bg-gray-100 flex items-center justify-center`} style={{boxShadow: 'inset 0 4px 16px 0 #bbb, 0 4px 24px 0 #bbb'}}>
      ...
      <form className="w-full space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="flex items-center gap-2 mt-2">
          <input type="checkbox" id="remember10" className="w-5 h-5 accent-blue-400 border-2 border-black rounded" />
        ...
        <div className="text-center mt-4">
          <span className="text-base text-blue-700 font-mono">¿No tienes cuenta?{' '}
            <button
              type="button"
